...
int main(int argc, char *argv[]) {
  ...
  for (int times = 0; times < 10000; ++times) {
    Rectangle R, S;
    if (argc == 9) {
      R.x = atoi(argv[1]), R.y = atoi(argv[2]),
      R.width = atoi(argv[3]), R.height = atoi(argv[4]);
      S.x = atoi(argv[5]), S.y = atoi(argv[6]),
      S.width = atoi(argv[7]), S.height = atoi(argv[8]);
    } else {
